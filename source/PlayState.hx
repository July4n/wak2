	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['week1_nomiss', 'week2_nomiss', 'week3_nomiss', 'week4_nomiss',
				...
				'week12_nomiss', 'Funkin master', 'Kassetto', 'just like the old days',
				'Super Stars', 'you finally have an iphone', 'Trio shooter', ]);
	...
	private function checkForAchievement(achievesToCheck:Array<String> = null):String
	{
		...
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled) {
				...
				if (achievementName.contains(WeekData.getWeekFileName()) && achievementName.endsWith('nomiss')) // any FC achievements, name should be "weekFileName_nomiss", e.g: "weekd_nomiss"; //Simplify FC Week Awarding by BeastlyGhost
				{
				...
				switch(achievementName)
				{
					...
					case 'Funkin master':
						if(Paths.formatToSongPath(SONG.song) == 'tutorial-remix' && !usedPractice) {
							unlock = true;
						}
					case 'Kassetto':
					...
					case 'you finally have an iphone':
						if(Paths.formatToSongPath(SONG.song) == 'i-aint-got-no-iphone' && !usedPractice) {
							unlock = true;
						}
					case 'Trio shooter':
						if(Paths.formatToSongPath(SONG.song) == 'Bro' && !usedPractice) {
							unlock = true;
						}
				}
